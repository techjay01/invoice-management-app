...
const SunIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    <circle cx="10" cy="10" r="2.56" fill="currentColor"/>
    <path d="M10 .5V2.6M10 17.4v2.1M2.1 2.1l1.48 1.48M16.42 16.42l1.48 1.48M.5 10H2.6M17.4 10h2.1M2.1 17.9l1.48-1.48M16.42 3.58l1.48-1.48"
